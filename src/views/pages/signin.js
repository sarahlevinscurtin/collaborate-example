      ...
      <div class="page-content page-centered">
        <div class="signinup-box">
          ...
          <sl-form class="form-signup dark-theme" @sl-submit=${this.signInSubmitHandler}>          
            ...
            <div class="input-group">
              <sl-input name="password" type="password" placeholder="Enter Password Here Right Now" required toggle-password></sl-input>
            </div>
            <sl-button class="submit-btn" type="primary" submit style="width: 100%;">Sign Right Now In</sl-button>
          </sl-form>
          <p>Don't have an Account? <a href="/signup" @click=${anchorRoute}>Sign Up Right Now</a></p>
        </div>
      </div>
    `
